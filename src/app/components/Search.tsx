...
export const Search = () => {
  return (
    <div className="w-[calc(100%-10vw)] max-w-260 bg-gradient-to-r from-colors-primary-hard to-colors-secondary-clear  mx-auto -mt-10  relative px-8 flex flex-col justify-between">
      <div className="mt-8">
